...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_ortho_5x12(
        ...
        KC_TAB, MEH(KC_F), HYPR(KC_LEFT), LCA(KC_N), HYPR(KC_RGHT), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_ESC, LCAG(KC_LEFT), LCA(KC_LEFT), LCA(KC_N), LCA(KC_RGHT), LCAG(KC_RGHT), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, 
