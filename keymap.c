...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x12(
        ...
        TG(2), KC_LCTL, KC_TAB, LALT_T(KC_TAB), KC_LGUI, KC_SPC, KC_BSPC, TG(1), KC_MPLY, KC_MUTE, KC_VOLD, KC_VOLU
        ),
	[1] = LAYOUT_ortho_5x12(
	...
	[2] = LAYOUT_ortho_5x12(
        ...
        KC_TAB, MEH(KC_F), HYPR(KC_LEFT), MEH(KC_N), HYPR(KC_RGHT), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_ESC, LCAG(KC_LEFT), LCA(KC_LEFT), MEH(KC_N), LCA(KC_RGHT), LCAG(KC_RGHT), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, 
